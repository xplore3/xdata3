      ...
      notes_search: {
        ...
        query_params_desc: {
          baseInfoRequest: {
            "type": "",
            "createTime": "30d",
            "contentTags": "一般为空，不需要填写；是一个数组[]，根据用户的背景确定，取值范围为['合集', '教程', 'ootd', '测评', '探店', 'vlog', '沉浸式', '仿妆', '彩妆试色', 'plog', '开箱', '成分解析', '日系', '氛围感', '高级感', '校园风', '韩系', '复古', '中性风', '甜酷', '纯欲', '欧美风', '低脂低卡', '自律生活', '职场生活', '极简主义', '露营徒步', '痘痘肌', '黄皮', '敏感肌', '干皮', '白皮', '油皮', '瑕疵皮', '混合肌', '隔离防晒', '保湿补水', '抗老', '控油', '祛痘祛闭口', '祛黄', '眼部护理', '修复', '抗氧化', '美白', '抗炎', '去皱', '淡斑']中的0~5项；不要超过5个，一定不要有这些范围之外的内容。",
            "firstType": "根据用户的背景确定，这个数组[美妆', '美容个护', '鞋包潮玩', '穿搭打扮', '美食', '母婴育儿', '旅游出行', '家居家装', '教育', '生活', '运动健身', '兴趣爱好', '影视综', '婚嫁', '摄影摄像', '萌宠', '情感星座', '科技互联网', '资讯', '健康养生', '科学科普', '职场', '交通工具', '其他']中的一项,或者空；不要有这些项之外的内容",
            "noteType": ""
          },
          custom: {},
          endTime: "",
