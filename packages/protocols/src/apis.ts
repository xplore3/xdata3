      ...
      notes_search: {
        ...
        query_params_desc: {
          baseInfoRequest: {
            "type": "",
            "createTime": "30d",
            "contentTags": "是一个数组[]，根据用户的背景或输入确定，取值范围为['合集', '教程', 'ootd', '测评', '探店', 'vlog', '沉浸式', '仿妆', '彩妆试色', 'plog', '开箱', '成分解析', '日系', '氛围感', '高级感', '校园风', '韩系', '复古', '中性风', '甜酷', '纯欲', '欧美风', '低脂低卡', '自律生活', '职场生活', '极简主义', '露营徒步', '痘痘肌', '黄皮', '敏感肌', '干皮', '白皮', '油皮', '瑕疵皮', '混合肌', '隔离防晒', '保湿补水', '抗老', '控油', '祛痘祛闭口', '祛黄', '眼部护理', '修复', '抗氧化', '美白', '抗炎', '去皱', '淡斑']中的0~5项；不要超过5个，一定不要有这些范围之外的内容。",
