...
data3Logger.info("Loading embedding settings:", {
...
data3Logger.debug("Loading character settings:", {
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        data3Logger.log(`Loaded .env file from: ${envPath}`);
    }
...
data3Logger.info("Parsed settings:", {
